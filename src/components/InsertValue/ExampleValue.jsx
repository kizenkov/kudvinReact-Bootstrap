...
function ExampleValue({a, b, c, d, arr, colorsArray, isInputSecond}) {
    ...
    arr.push([x, y, f, e, input1, input2, result1, result2, isInputSecond]);
    ...
    return (<>
            {
                isInputSecond && <div className='row justify-content-around text-center'>
