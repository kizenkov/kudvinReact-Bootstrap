    ...
    return (
        <div><br/><br/>
            ...
            <div className='row justify-content-center main'>
                <p className='col-11 ' >
                    <p className='fs-4'>Сегодня не всем удаётся полностью изолировать своих чад от современных гаджетов.
                    ...
                    <div id="carousel1" className="carousel carousel-dark slide text-center" data-bs-ride="carousel">
