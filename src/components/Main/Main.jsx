...
function Main() {
    ...
    function scrollFunction() {
        if (document.documentElement.scrollTop > 900) {
            buttonUp.current.style.display = "block"
        } else {
    ...
    return (
        <div id='start'><br/><br/>
            ...
            <div className='row justify-content-center main'>
                <p className='col-11 '>
                    <p className='fs-4 mainText'>Сегодня не всем удаётся полностью изолировать своих чад от
                        современных
                        гаджетов.
                        И, чтобы скоротать время, сидя в очереди, или не заскучать в машине, дети просят телефон.
                        Так
                        пусть они проведут это время с пользой!
                        Перед Вами простой и понятный набор упражнений для детей от 3х до 8ми лет, благодаря которым
                        мои
                        дети выучили буквы, слоги и тренируются в счёте и задачах! А с веселыми помощниками обучение
                        будет проходить вдвойне интересней! <img src={helper} className='helperForMain'
                                                                 alt='helper'/>
                    </p>
                    ...
                    <div id='carousel1' className='carousel carousel-dark slide ' data-bs-ride='carousel'>
                        <div className='carousel-inner text-center'>
                            <div className='carousel-item active'>
                                <img src={letters} className=' ' alt='letters'/>
                            </div>
                            <div className='carousel-item'>
                                <img src={syllables} className=' ' alt='syllables'/>
                            </div>
                        </div>
                    ...
                    <div id='carousel2' className='carousel carousel-dark slide' data-bs-ride='carousel'>
                        <div className='carousel-inner text-center'>
                            <div className='carousel-item active'>
                                <img src={numbers} className=' ' alt='numbers'/>
                            </div>
                            <div className='carousel-item'>
                                <img src={task} className=' ' alt='task'/>
                            </div>
                        </div>
                    ...
                    <p className='fs-4 mainText'>
                        «Примеры» делятся на простые и сложные, в которых используются цифры от 0 до 10 и от 10 до
                        30
                        соответственно. В разделе «Примеры» идет счёт затраченного времени, а в разделе «Вставить
                        число»
                    ...
                    <div id='carousel3' className='carousel carousel-dark slide' data-bs-ride='carousel'>
                        <div className='carousel-inner text-center'>
                            <div className='carousel-item active'>
                                <img src={insertValue} className=' ' alt='insertValue'/>
                            </div>
                            <div className='carousel-item'>
                                <img src={examples} className=' ' alt='examples'/>
                            </div>
                        </div>
            ...
            <h1 className='text-center'>Успехов!</h1>
